...
public class DialogueScene4a : MonoBehaviour
{
    ...
    {         // main story function. Players hit next to progress to next int
        ...
        else if (primeInt == 101)
        {
            ...
            //Char4GregorySpeech.text = "";
            Char5PJ.text = "P.J";
            Char5PJSpeech.text = "I don’t have the best feeling about this…";
            Char6Narrator.text = "";
            Char6Narration.text = "";
        ...
        else if (primeInt == 102)
        {
            ...
            Char5PJSpeech.text = "";
            Char6Narrator.text = "Narrator";
            Char6Narration.text = "Your heart races as the sound draws closer and closer… A flash of blue and red leaps out of the shadows towards you…";
        ...
        else if (primeInt == 106)
        {
            ...
            //Char4GregorySpeech.text = "";
            Char5PJ.text = "P.J";
            Char5PJSpeech.text = " Look at the anguish in his eyes… I feel like this on the inside…";
            Char6Narrator.text = "";
            Char6Narration.text = "";
        }
        ...
        else if (primeInt == 110)
        {
            ...
            Char5PJSpeech.text = "";
            Char6Narrator.text = "???";
            Char6Narration.text = "YOU SEE MY ARMS? YOURS WILL LOOK THE SAME BY THE TIME THE MACHINE’S DONE WITH YA!";
        }
        ...
        else if (primeInt == 200)
        {
            Image_PJ.SetActive(false);
            Char1You.text = "You";
            Char1YouSpeech.text = "Guys, this is kinda boring… He’s the only dude in this room";
            Char2Chad.text = "";
            Char2ChadSpeech.text = "";
            //Char3Gwen.text = "";
            //Char3GwenSpeech.text = "";
    ...
    public void SceneChange1()
    {
        ...
        //Char4GregorySpeech.text = "";
        Char5PJ.text = "P.J";
        Char5PJSpeech.text = "This feeling of fear… It makes me feel more alive than I have in years…";
        Char6Narrator.text = "";
        Char6Narration.text = "";
        primeInt = 199;
        Choice1a.SetActive(false);
    ...
    {
        {
            ...
            Char1YouSpeech.text = "";
            Char2Chad.text = "Chad";
            Char2ChadSpeech.text = "We’re getting you some serious help after all of this…";
            //Char3Gwen.text = "";
            //Char3GwenSpeech.text = "";
            //Char4Gregory.text = "";
            //Char4GregorySpeech.text = "";
        ...
        public void SceneChange1()
        {
            ...
            Char1YouSpeech.text = "";
            Char2Chad.text = "Chad";
            Char2ChadSpeech.text = "Maybe we should get out of here… Like to find a real jump scare or something.";
            //Char3Gwen.text = "";
            //Char3GwenSpeech.text = "";
            //Char4Gregory.text = "";
            //Char4GregorySpeech.text = "";
        ...
        public void SceneChange1()
        {
            ...
            Char1YouSpeech.text = "";
            Char2Chad.text = "Chad";
            Char2ChadSpeech.text = "Let’s roll.";
            //Char3Gwen.text = "";
            //Char3GwenSpeech.text = "";
            //Char4Gregory.text = "";
            //Char4GregorySpeech.text = "";
